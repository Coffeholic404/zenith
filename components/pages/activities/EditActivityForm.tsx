...
export default function EditActivityForm({ activityId }: { activityId: string }) {
  ...
  } = useGetActivityByIdQuery({ uniqueID: activityId }, { refetchOnMountOrArgChange: true });
  ...
  } = useGetCourseByIdQuery({ uniqueID: watchedCharacter || '' }, { skip: !watchedCharacter });
  ...
  useEffect(() => {
    if (isCourseDetailsSuccess && rawParticipants.length > 0 && addedJumpers.length > 0) {
      ...
      const hasChanges = updatedJumpers.some((jumper, index) => jumper.studentName !== addedJumpers[index].studentName);
            ...
            <CardContent>
              <FieldGroup>
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field orientation="responsive" data-invalid={fieldState.invalid}>
                      <Label htmlFor="form-rhf-select-character-edit" className="font-vazirmatn text-[14px]  block">
                        حرف الدورة
                      </Label>
                      <Select
                        name={field.name}
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field orientation="responsive" data-invalid={fieldState.invalid}>
                      <Label htmlFor="form-rhf-select-plane-edit" className="font-vazirmatn text-[14px]  block">
                        الطائرة
                      </Label>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field orientation="responsive" data-invalid={fieldState.invalid}>
                      <Label htmlFor="form-rhf-select-location-edit" className="font-vazirmatn text-[14px]  block">
                        المكان
                      </Label>
                      <Select name={field.name} value={field.value} onValueChange={field.onChange}>
                        <SelectTrigger
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field orientation="responsive" data-invalid={fieldState.invalid}>
                      <Label htmlFor="startDate-edit" className="font-vazirmatn text-[14px]  block">
                        تاريخ البدء
                      </Label>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <Label htmlFor="windSpeed-edit" className="font-vazirmatn text-[14px]  block">
                        سرعة الرياح
                      </Label>
                      <Input
                        {...field}
              ...
              <div className="mt-4 space-y-4" id="student-table">
                <div className="bg-trainerTableBg rounded-xl px-4 py-2 flex items-center gap-36 font-vazirmatn text-sm">
                  <span className=" text-trainerTableHeaderTxt text-[15px]">اسم الطلاب</span>
                  ...
                  addedJumpers.map((jumper, index) => (
                    ...
                    >
                      <div className=" flex items-center gap-40">
                        ...
                        {jumper.isNew && <span className="text-xs text-sidebaractive">(جديد)</span>}
                      </div>
                      <Button
                        type="button"
                        variant="ghost"
              ...
              <FieldGroup>
                <div className=" w-full flex">
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field orientation="responsive" data-invalid={fieldState.invalid}>
                        <Label htmlFor="form-rhf-select-student-edit" className="font-vazirmatn text-[14px]  block">
                          الطالب
                        </Label>
                        <Select
                          name={field.name}
                ...
                <div className=" w-full grid grid-cols-2 gap-4">
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field orientation="responsive" data-invalid={fieldState.invalid} className="col-start-1">
                        <Label htmlFor="currentTrainer1Id-edit" className="font-vazirmatn text-[14px]  block">
                          المدرب 1
                        </Label>
                        <Select
                          value={field.value || ''}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-2 row-start-1">
                        <Label htmlFor="currentTrainer1Note-edit" className="font-vazirmatn text-[14px]  block">
                          ملاحظات المدرب 1
                        </Label>
                        <Input
                          {...field}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field orientation="responsive" data-invalid={fieldState.invalid} className="col-start-1">
                        <Label htmlFor="currentTrainer2Id-edit" className="font-vazirmatn text-[14px]  block">
                          المدرب 2
                        </Label>
                        <Select
                          value={field.value || ''}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-2 row-start-2">
                        <Label htmlFor="currentTrainer2Note-edit" className="font-vazirmatn text-[14px]  block">
                          ملاحظات المدرب 2
                        </Label>
                        <Input
                          {...field}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field orientation="responsive" data-invalid={fieldState.invalid} className="col-start-1">
                        <Label htmlFor="currentTrainer3Id-edit" className="font-vazirmatn text-[14px]  block">
                          المدرب 3
                        </Label>
                        <Select
                          value={field.value || ''}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-2 row-start-3">
                        <Label htmlFor="currentTrainer3Note-edit" className="font-vazirmatn text-[14px]  block">
                          ملاحظات المدرب 3
                        </Label>
                        <Input
                          {...field}
                ...
                <div className=" w-full grid grid-cols-2 gap-4">
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-1 block">
                        <Label htmlFor="currentJumpCount-edit" className="font-vazirmatn text-[14px]  block">
                          عدد القفزات
                        </Label>
                        <Input
                          {...field}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-1 block">
                        <Label htmlFor="currentJumpType-edit" className="font-vazirmatn text-[14px]  block">
                          نوع القفز
                        </Label>
                        <Input
                          {...field}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-1 block">
                        <Label htmlFor="currentParachuteOpiningTime-edit" className="font-vazirmatn text-[14px]  block">
                          ارتفاع السقوط الحر
                        </Label>
                        <Input
                          {...field}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-1 block">
                        <Label
                          htmlFor="currentParachuteOpinignHeight-edit"
                          className="font-vazirmatn text-[14px]  block"
                        >
                          ارتفاع فتح المظلة
                        </Label>
                        <Input
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-2 row-start-1 block">
                        <Label htmlFor="currentLandingLocation-edit" className="font-vazirmatn text-[14px]  block">
                          موقع الهبوط
                        </Label>
                        <Input
                          {...field}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-2 row-start-2 block">
                        <Label htmlFor="currentFreeFallTime-edit" className="font-vazirmatn text-[14px]  block">
                          وقت السقوط الحر
                        </Label>
                        <Input
                          {...field}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid} className="col-start-2 row-start-3 block">
                        <Label htmlFor="currentPlaneExitHeight-edit" className="font-vazirmatn text-[14px]  block">
