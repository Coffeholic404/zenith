...
import EditUnitModel from './editUnit-model';
import { useDeleteUnitMutation } from '@/services/unit';
      ...
      <AlertDialogContent className="rtl" dir="rtl">
        <AlertDialogHeader className="text-right">
          ...
          <AlertDialogDescription className="text-right font-vazirmatn">
            هل أنت متأكد من حذف وحدة "{itemName}"؟
            <br />
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const handleDeleteConfirm = async () => {
        try {
          await deleteUnit({ id: row.original.id }).unwrap();
          toast({
      ...
      return (
        <>
          ...
          <DeleteConfirmationDialog
            ...
            itemName={row.original.unitName}
...
export const unitColumnsNames = [
  ...
  { label: 'اسم الوحدة', dataIndex: 'unitName' },
