...
import { useDeletePlaceMutation } from "@/services/place";
...
import EditPlaceModel from "./editPlaces-model";
 export type placesColumns = {
    uniqueID: string,
    name: string,
    // notes: string,
}
            ...
            <AlertDialogContent className="rtl" dir="rtl">
                <AlertDialogHeader className="text-right">
                    ...
                    <AlertDialogDescription className="text-right font-vazirmatn">
                        هل أنت متأكد من حذف المكان "{itemName}"؟
                        <br />
...
export const PlacesColumns: ColumnDef<placesColumns>[] =[
    {
    ...
    // },
    {
        ...
        cell: ({ row }) => {
            ...
            const [deletePlaceMutation, { isLoading: isDeleting }] = useDeletePlaceMutation();  
            ...
            const handleDelete = async () => {
                try {
                    await deletePlaceMutation({uniqueID: row.original.uniqueID}).unwrap();
                    toast({
                        title: "تم حذف المكان",
            ...
            return (
                ...
                <div className="flex items-center justify-end gap-3 pe-4">
                    <EditPlaceModel id={row.original.uniqueID} name={row.original.name} />
...
export const PlacesColumnsNames = [
