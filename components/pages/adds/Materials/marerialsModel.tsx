      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="sm:max-w-[425px] rtl [&>button]:hidden space-y-4" dir="rtl">
          ...
          <DialogFooter className="flex-row-reverse gap-3">
            ...
            <Button size="sm" variant="outline" className='bg-sidebaractive text-white w-24 rounded-2xl hover:bg-sidebaractive hover:brightness-110 hover:text-white font-vazirmatn' type="submit">
              حفظ
            </Button>
