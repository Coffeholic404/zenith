...
import { useUpdateTrainingCourseMutation } from "@/services/trainingCourses";
...
export default function EditTrainingCourseModel({ id, name }: EditSkillModelProps) {
  const [isOpen, setIsOpen] = useState(false);
  const [updateTrainingCourse, { isLoading }] = useUpdateTrainingCourseMutation();
  ...
  const onSubmit = async (data: EditSkillFormData) => {
    try {
      ...
      toast({
        title: "تم بنجاح",
        description: "تم تعديل اسم الدورة التدريبية بنجاح",
        variant: "default",
      });
