      ...
      <Card className="w-full p-[17px] min-h-36">
        <CardContent className=" p-0 space-y-4">
                ...
                <PopoverContent className=" w-[120px] rounded-xl">
                  {!isAdmin && (
                    <Button
                      variant="ghost"
                      className=" w-full"
                      onClick={() => router.push(`/courses/edit-course/${course.uniqueID}`)}
                    >
          ...
          <div className=" flex justify-center items-center gap-4 flex-wrap">
            <Button
              variant="outline"
              onClick={() => router.push(`/evaluation/${course.uniqueID}`)}
            ...
            <Popover open={isActivitiesPopoverOpen} onOpenChange={setIsActivitiesPopoverOpen}>
              <PopoverTrigger asChild>
                <Button variant="outline" className=" font-vazirmatn text-sm rounded-xl" onClick={handleShowActivities}>
                  عرض النشاطات
                </Button>
              </PopoverTrigger>
              <PopoverContent className=" w-[280px] rounded-xl">
                <div className="space-y-2">
                  <p className="font-vazirmatn font-semibold text-sm text-cardTxt mb-3">اختر نشاط</p>
                  {course.activities &&
