          ...
          <CardContent className="pt-12 pb-6 text-center relative">
            ...
            <div className="absolute -top-10 left-1/2 h-20 w-20 -translate-x-1/2 rounded-full border-4 flex items-center justify-center z-[3]">
              <Avatar className="h-20 w-20 z-10 border-4 border-background">
                <AvatarImage className="text-xl z-10" src={user.avatar} alt={user.name} />
            ...
            <div className="mb-6 flex justify-center space-x-3">
              <Link href={user.social.facebook} className="text-muted-foreground hover:text-primary">
                <Facebook className="h-5 w-5" />
              </Link>
              <Link href={user.social.instagram} className="text-muted-foreground hover:text-primary">
                <Instagram className="h-5 w-5" />
              </Link>
              <Link href={user.social.linkedin} className="text-muted-foreground hover:text-primary">
                <Linkedin className="h-5 w-5" />
              </Link>
              <Link href={user.social.twitter} className="text-muted-foreground hover:text-primary">
