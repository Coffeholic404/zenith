  ...
  return (
    <Card className="flex flex-col border-none shadow-none">
      ...
      <CardContent className="flex flex-1 items-center pb-0">
        <ChartContainer config={chartConfig} className="mx-auto aspect-square w-full max-w-[250px] max-h-[200px]">
          <RadialBarChart
            data={chartData}
            startAngle={180}
            endAngle={0}
                  ...
                  if (viewBox && 'cx' in viewBox && 'cy' in viewBox) {
                    return (
                      <text x={viewBox.cx} y={viewBox.cy} textAnchor="middle">
                        ...
                        <tspan x={viewBox.cx} y={(viewBox.cy || 0) + 4} className="font-bold text-sm">
