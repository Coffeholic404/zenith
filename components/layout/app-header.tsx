              ...
              <DropdownMenuTrigger asChild>
                <div className=" flex gap-4">
                  <div className=" text-left cursor-pointer">
                    <p className="font-normal text-xs  text-userWelcomClr">welcom</p>
                    <p className=" text-xs font-medium text-userEmailClr  flex flex-row-reverse">
                      {isDropdownOpen ? (
                        <ChevronUp className="h-4 w-4 text-userWelcomClr " />
                      ) : (
                        <ChevronDown className="h-4 w-4 text-userWelcomClr " />
                      )}
                      someone@gmail.com
                    </p>
                  </div>
