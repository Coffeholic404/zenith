    ...
    >
      <Sidebar side="right" className="border-none">
        ...
        >
          ...
          >
            <Image alt="zenith logo" src={logo} />
            <div className=" pt-2">
              <Image alt="zenith text" src={zen} />
              <p className=" font-vazirmatn text-subtext font-medium text-[12px]">نظام إدارة المظلات</p>
            </div>
          </div>

          <SidebarTrigger className={cn('transition-all duration-300', state === 'collapsed' ? 'relative' : '')}>
              ...
              <React.Fragment key={item.title}>
                {item.subItems ? (
                  <Collapsible
                    ...
                    className="w-full"
                  >
                    <SidebarMenuItem className={cn(state === 'collapsed' ? 'w-full' : 'w-[calc(100%-50px)]')}>
                            ...
                            <SidebarMenuSubButton asChild className="flex items-center">
                              <Link href={subItem.href}>
                                ...
                                <subItem.icon
                                  className={cn(
                                    'h-4 w-4',
                                    pathname === subItem.href ? 'text-sidebaractive' : 'text-[#979797]'
                                  )}
                                />
                                <span
                                  className={cn(
                                    'mr-2 rtl:mr-2 rtl:ml-0 font-normal text-base font-vazirmatn',
                                    pathname === subItem.href ? '!text-sidebaractive' : 'text-[#979797]'
                                  )}
                                >
                                  {subItem.title}
