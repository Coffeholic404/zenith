...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-4 text-center rtl">
      <div className="max-w-md space-y-6 flex flex-col items-center ">
        <h1 className="text-3xl font-bold">عذراً، الصفحة غير موجودة!</h1>
        <p className="text-muted-foreground text-center">
          عذراً، لم نتمكن من العثور على الصفحة التي تبحث عنها. ربما أخطأت في كتابة الرابط؟ تأكد من التهجئة الصحيحة.
        </p>
        <div className="relative mx-auto h-64 w-64">
          <svg
            className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-13y2yvu"
            focusable="false"
            aria-hidden="true"
            viewBox="0 0 480 360"
          ...
          >
            <defs>
              <linearGradient id=":r1:" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
                <stop offset="0%" stopColor="var(--palette-primary-main)"></stop>
                <stop offset="100%" stopColor="var(--palette-primary-main)" stopOpacity="0"></stop>
              </linearGradient>
            </defs>
            <path
              fill="url(#:r1:)"
        ...
        <Link href="/">
          <Button className="mt-8 px-8">العودة للرئيسية</Button>
        </Link>
      </div>
    </div>
  );
