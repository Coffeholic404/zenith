          ...
          <Card className="h-full border-none shadow-sm bg-white rounded-3xl overflow-hidden">
            ...
            <CardContent className="px-8 pb-8 pt-4">
              <div className="flex flex-col gap-1">
                ...
                <InfoRow
                  label="وقت الخروج من الطائرة"
                  value={accident.exitAltitude ? `${accident.exitAltitude} قدم` : '-'}
                />
                <InfoRow
                  label="ارتفاع فتح المظلة"
                  value={accident.deployAltitude ? `${accident.deployAltitude} قدم` : '-'}
                />
                <InfoRow
                  label="وقت السقوط الحر"
                  value={accident.freefallTime ? `${accident.freefallTime} ثانية` : '-'}
                />
              </div>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex flex-wrap gap-3 justify-start">
                  {accident.trainer1Name && (
                    <Badge
                      variant="secondary"
                      className="bg-blue-100/50 text-blue-500 hover:bg-blue-100 px-4 py-2 text-sm font-medium rounded-xl border-none"
                    >
                      {accident.trainer1Name}
                    </Badge>
                  )}
