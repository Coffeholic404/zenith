...
function page() {
    return (
        <section className=' '>
            <div className='student-div relative rounded-xl w-full p-4 h-40 flex flex-col items-end justify-end'> 
            ...
            <div className=' mt-24 flex gap-20'>
                <div className=' space-y-6 min-w-[513px]'>
                    <div className='flex justify-between items-center border-b  pb-2 '>
                        <p className='font-vazirmatn font-bold text-[#868687]'>الاسم الثلاثي</p>
                        <p className=' font-vazirmatn font-normal text-[#868687]'>عباس احمد</p>
                    </div>
                    <div className='flex justify-between items-center border-b  pb-2 '>
                        <p className='font-vazirmatn font-bold text-[#868687]'>الاسم الثلاثي</p>
                        <p className=' font-vazirmatn font-normal text-[#868687]'>عباس احمد</p>
                ...
                <div className=' bg-mainBg rounded-[21px] min-w-[461px] p-6'>
