...
export const {
  ...
  useGetMerchantReqestQuery,
  useAddMerchantsMutation,
  useUpdateMerchantsMutation,
  useUpdateMerchantReqestMutation,
  useDeleteMerchantsMutation,
  useGetMerchantsByIDQuery
} = Merchants;
